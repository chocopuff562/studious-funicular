...
def main_content():
    ...
    if app_mode=='Tree': 
        ...
        engine.say("Assume the tree pose.Before you start, listen to the instructions Stand on one leg with your arms raised above your head. Hold your position steady.")
        engine.runAndWait()
        with col3:
        ...
        # Speak out the instruction
        engine.say("Assume the mountain pose  Before you start, listen to the instructions Stand straight with your feet together, and arms by your sides. Focus on your breathing and keep your spine straight.")
        engine.runAndWait()
        with col3:
            st.write("Webcam Live Feed")
            button=st.empty()
        ...
        # Speak out the instruction
        engine.say("Assume the warrior  pose Before you start, listen to the instructions Stand with your legs wide apart, raise your arms parallel to the floor, and keep your gaze forward over your front hand.")
        engine.runAndWait()
